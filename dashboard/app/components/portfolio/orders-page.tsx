          ...
          right={
            data && (
              ...
              <button
                type="button"
                onClick={reload}
                className="inline-flex h-9 items-center rounded-lg border border-line bg-[#0e1217]/[0.97] px-3 text-sm font-medium text-ink-2 hover:border-line-strong hover:text-ink"
              >
                Refresh
              </button>
              </>
          ...
          <>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              {[
                ...
                <div key={t.label} className="rounded-2xl border border-line bg-[#0e1217]/[0.97] px-4 py-3.5 backdrop-blur-sm">
